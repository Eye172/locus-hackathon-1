...
- **Поиск в соцсетях по названию — как это делает студент**: TikTok «Топ» (там же слайдшоу со вкладки «Фото» — это уже фотографии) и Instagram «Популярное» и хэштег вуза. Запрос строится из имён самого вуза, а не из списка: английское название и сокращение, которым реально пользуются, — `KBTU`, `КазНУ`, `UofT`. Официальное русское название («Казахстанско-Британский технический университет») TikTok не находит вовсе, его никто не набирает; из нескольких сокращений в Wikidata выбирается то, чьи заглавные буквы — инициалы нынешнего названия (КазНУ, а не советское КазГУ). Это поисковая выдача: по «Nazarbayev University» приходят и посты о Назарбаев Интеллектуальных школах, поэтому совпавшей подписи мало — ИИ должен узнать сам кампус. Рилсы открываются и дают кадры из середины, как ролики TikTok.
