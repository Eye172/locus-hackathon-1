...
| Агент | Что делает |
|---|---|
| **Scout** | ищет кандидатов параллельно: официальный сайт вуза и его соцсети (Instagram и TikTok через ScrapeCreators, Telegram, YouTube-канал — кадры из середины роликов, VK по ключу), Wikimedia Commons (категория, «depicts», геопоиск, поиск по названию), статьи Википедии, Google Картинки по категориям через Serper («<вуз> общежитие», «… библиотека»…), ролики о вузе с любых каналов (YouTube Data API), поиск TikTok, Openverse, геофото Mapillary у кампуса |
...
Windy (embed), официальные сайты вузов, Google Картинки через Serper, Instagram и TikTok через ScrapeCreators, YouTube Data API
