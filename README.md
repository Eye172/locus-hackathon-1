...
- **Два прохода**: первый укладывается в требование кейса — полезный профиль за ≤ 25 с. После того как он уже на
  экране, тот же запрос продолжает работу: снимаются ограничения на соцсети (все слайды каруселей TikTok и Instagram,
  кадры из десяти роликов на источник, вся лента вуза и все посты с его отметкой), ИИ-инспектор досматривает то, что не
  успел, и профиль обновляется в открытой странице. Поток SSE закрывается только на финальном событии. Назарбаев
  Университет: 136 фото на 18-й секунде, 184 — на 30-й.
